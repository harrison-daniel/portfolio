      ...
      <div ref={ref} className='relative mx-auto mb-44 max-w-7xl'>
        {data.map((item, index) => (
          <div
            ...
            <div className='sticky top-40 z-30 flex max-w-xs flex-col items-center self-start md:w-full md:flex-row lg:max-w-sm'>
...
//         <h2 className='mb-4 flex max-w-4xl justify-center text-2xl font-bold text-black dark:text-white md:text-4xl'>
//           My Work
//         </h2>
...
//       <div ref={ref} className='relative mx-auto max-w-7xl pb-36'>
//         {data.map((item, index) => (
//           <div
//             key={index}
//             className='flex justify-start pt-10 md:gap-10 md:pt-40'>
