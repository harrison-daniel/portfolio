...
export default function MobileNavbar() {
  ...
  const [activeSection, setActiveSection] = useState('/'); // Initialize activeSection
  ...
  useEffect(() => {
    ...
    // Clean up by removing 'overflow-hidden' when component unmounts
    return () => {
      document.body.classList.remove('overflow-hidden');
    };
  }, [mobileNavOpen]);
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setActiveSection(foundSection || '/'); // Update the activeSection state
    };
